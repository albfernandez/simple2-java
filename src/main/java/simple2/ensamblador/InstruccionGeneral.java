 ...
 * para cada tipo de instrucción de la arquitectura. Esta clase define el
...
public abstract class InstruccionGeneral {
	 ...
	 * validos (no son letras, ni numeros , si separadores validos, ni símbolos
	 * especiales válidos.
	 */
	protected static final String CONTIENE_CARACTERES_INVALIDOS = "La instrucción contiene caráteres no válidos\n";
	...
	/**
	 * Metodo abstracto de la clase que implementan las clases hijas. Su función
	...
	/**
	 * Comprueba si una instruccion tiene caracteres no válidos. (los caracteres
	...
	/**
	 * Separa los distintos operandos de una instrucción y mete cada uno como un
	...
	/**
	 * Devuelve la representación en número binario de 32 bits del entero que
