...
public class AreaTexto extends javax.swing.JTextArea {
	...
	public class MyUndoableEditListener implements UndoableEditListener {
		/**
		 * Cuando ocurre una nueva acción se la añade al administrador de
		 * acciones.
		 * 
		 * @param e
		 *            evento
	...
	/**
	 * Descarta todas las acciones para deshacer que tenía el Administrador de
	 * acciones
	 */
	 ...
	 * 
	 * @param estado
	 *            - debería ser: true si se ha modificado el texto. false si no
	 ...
	 * 
	 * @param doc
	 *            - Estilo que tendrá el área de texto.
	 */
	 ...
	 *
	 * @param linea
	 *            el número de la linea de la que queremos obtener el texto.
	 * @return El texto contenido en linea, una cadena vacía en caso de no
	 *         existir dicha linea.
	 */
	...
	/**
	 * Muestra información sobre la posición en la que esta el cursor, linea,
	...
	private class PopupListener extends MouseAdapter {
		/**
		 * Cuando se presiona un botón del ratón puede que se muestre el menú
		 * emergente. Depende del botón pulsado.
		 * 
		 * @param e
		 *            Evento de ratón.
		 */
		...
		/**
		 * Cuando un botón del ratón es liberado puede que se muestre el menú
		 * emergente. Depende del botón pulsado.
		 * 
		 * @param e
		 *            Evento de ratón.
		...
		/**
		 * Muestra el menú emergente asociado al editor. Si el menu emergente no
		 * existe no se hace nada. Si el menu emergente exite se muestra en
		 * pantalla en la posición del puntero del ratón.
		 *
		 * @param e
		 *            Evento.
		 */
