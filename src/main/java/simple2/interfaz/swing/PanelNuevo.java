...
public class PanelNuevo extends JPanel {
	...
	/**
	 * Area donde se mostrará el resultado de ensamblar el código(si no hay
	 * errores)
	 */
	...
	/**
	 * Esta clase actualiza el texto que indica dónde se encuentra el cursor:
	 * linea, columna, ...
	 */
